...
<body style="font-size:12px; font-family:SimSun; width: 210mm;">
    ...
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日教师违纪扣分前5名:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
        <img src="${part1_2_1}" alt="" width="500" height="320" />
    </p>
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日学生违纪扣分前5名:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
        <img src="${part1_2_2}" alt="" width="500" height="320" />
    </p>
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日教师各违纪类型发生次数详情:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
        <img src="${part1_2_3}" alt="" width="500" height="320" />
    </p>
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日学生各违纪类型发生次数详情:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
    ...
    <p style="font-family:SimSun; font-size:15pt;margin: 25px 0;">二、详细情况</p>
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日教师教研得分排名前5名:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
        <img src="${part2_2_1}" alt="" width="500" height="320" />
    </p>
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日教师教研得分排名后5名:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
        <img src="${part2_2_2}" alt="" width="500" height="320" />
    </p>
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日各评价项得分详情:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
    ...
    <p style="font-family:SimSun; font-size:15pt;margin: 25px 0;">二、详细情况</p>
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日出勤率排名前5:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
        <img src="${part3_2_1}" alt="" width="500" height="320" />
    </p>
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日出勤率排名后5:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
    ...
    <p style="font-family:SimSun; font-size:15pt;margin: 25px 0;">二、详细情况</p>
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日教师考勤异常次数比列排行前5:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
        <img src="${part4_2_1}" alt="" width="500" height="320" />
    </p>
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日教师考勤异常次数比列排行后5:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
        <img src="${part4_2_2}" alt="" width="500" height="320" />
    </p>
    <p style="font-family:SimSun; font-size:10pt; text-indent: 35px;">今日各异常类型发生次数详情:</p>
    <p style="font-family:SimSun; font-size:10pt; text-align:center">
